...
export const FLOW_SECTIONS: FlowSection[] = [
  {
    ...
    titleAr: 'هويتنا',
    titleEn: 'Who We Are',
    bodyAr: 'مبادرة غير ربحية يرعاها المجتمع الفلسطيني بنفسه قامت من أجل توثيق و تثبيت مدى قوة الترابط بين أفراد و عائلات الشعب الفلسطيني في الداخل والشتات، عبر انتاج شجرة عائلة واحدة، ديناميكية، متكاملة، موثقة، ذات مصداقية، وشاملة لجميع الفلسطينيين.',
  ...
  },
  {
    ...
    bodyAr: 'الحفاظ على هويتنا الفلسطينية وتمسكنا بحق العودة وكيف ان إحياء تاريخنا وتراثنا الفلسطيني هو في غاية الأهمية الآن من أي وقت مضى.',
